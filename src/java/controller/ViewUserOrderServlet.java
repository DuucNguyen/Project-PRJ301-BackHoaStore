 ...
 * @author admin
 */
@WebServlet(name = "ViewUserOrderServlet", urlPatterns = {"/ViewUserOrderServlet"})
public class ViewUserOrderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (account == null) {
            ...
            ArrayList<OrdersDTO> listOrders = new ArrayList<>();
            try {
                listOrders = dao.getOrdersByUser(username);
            } catch (Exception e) {
            } finally {
