...
public class UpdateCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int numberOfProducts_new = Integer.parseInt(request.getParameter("numberOfProducts"));
        try {
            boolean rs = dao.updateCartQuantity(username, productID, numberOfProducts_new);
        } catch (Exception e) {
        } finally {
